...
public class TodoLocationPreference extends DialogPreference {
    ...
    private void initFolderTree() {
        if (mRootFolder == null) {
            mRootFolder = mCurrentSelection = new Tree<RemoteFolder>(new RemoteFolderImpl(null, null, null, null));
        } else {
    ...
    private void upToParent() {
        ...
        // FIXME: Remove this.
        RemoteFolder parent = new RemoteFolderImpl(null, null, null, null);
    ...
    private void addNew(String path) {
        ...
        if (tree == null) {
            // FIXME: Remove this.
            RemoteFolder folder = new RemoteFolderImpl(null, null, null, null);
