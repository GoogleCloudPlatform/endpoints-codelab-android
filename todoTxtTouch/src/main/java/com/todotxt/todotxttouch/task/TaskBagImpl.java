...
class TaskBagImpl implements TaskBag {
    protected TodoPreferences preferences;
    protected final LocalTaskRepository localRepository;
    protected final RemoteClientManager remoteClientManager;
    protected ArrayList<Task> tasks = new ArrayList<Task>();
    protected Date lastReload = null;
    ...
    protected void store(ArrayList<Task> tasks) {
